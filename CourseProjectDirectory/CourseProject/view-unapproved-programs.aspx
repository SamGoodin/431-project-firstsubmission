<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view-unapproved-programs.aspx.cs" Inherits="CourseProject.view_unapproved_programs" %>
...
<html>
<head>
    <title>View Approved Programs Page</title>
    <meta charset="utf-8" />
...
<body>
    ...
    <section class="wrapper">
        <div class="inner">
            <div class="box">
                <div class="content">
                    <h2 class="align-center">View Approved Programs</h2>
                    <hr />
