<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view-all-programs.aspx.cs" Inherits="CourseProject.view_all_programs" %>
...
<html>
<head>
    <title>View All Programs Page</title>
    <meta charset="utf-8" />
...
<body>
    ...
    <section class="wrapper">
        <div class="inner">
            <div class="box">
                <div class="content">
                    <h2 class="align-center">View All Programs</h2>
                    <hr />
