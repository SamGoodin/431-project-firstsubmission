...
{
    public partial class view_all_programs : System.Web.UI.Page
    {
        string cs;
        SqlConnection con;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (0 == 0)
            {
                ...
                try
                {
                    ...
                    con.Open();
                    string sql = "SELECT ProgramID, Name, Approved FROM PROGRAM";
                    ...
                    foreach (string[] columnVal in rows)
                    {
                        ...
                        if (columnVal[2] == "yes")
                        {
                            ...
                            approval.Click += (sender2, e2) =>
                            {
                                ...
                                con.Close();
                                //Session["programID"] = columnVal[0];
                                Response.Redirect("view-all-programs.aspx");
                            };
                        }
                        else
                        {
