<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sample.aspx.cs" Inherits="CourseProject.Sample" %>
<!DOCTYPE html>
<!--
		...
		<!-- Nav -->
			<nav id="menu">
				<ul class="links">
					...
					<li><a href="createprogram.aspx">Create a Program</a></li>
					<li><a href="create-admin.aspx">Create an Admin</a></li>
				</ul>
		...
		-->
			...
			<section id="banner">
				<div class="inner">
					...
					<a href="createprogram.aspx" class="button">Create a Program</a>
				</div>
